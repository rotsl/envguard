...
[![PyPI version](https://img.shields.io/badge/PyPI-envguard--tool%201.0.1-blue)](https://pypi.org/project/envguard-tool/)
[![Test PyPI](https://img.shields.io/badge/Test%20PyPI-envguard--tool%201.0.1-orange)](https://test.pypi.org/project/envguard-tool/)
...
- **Package publishing** — build and upload to PyPI
...
| `envguard publish` | `--token pypi-...` | Provide token directly |
| `envguard publish` | `--repository <url>` | Publish to a custom/TestPyPI URL |
| `envguard publish` | `--dry-run` | Build only, do not upload |
...
| Variable | Effect |
|---|---|
| `PYPI_TOKEN` | PyPI API token for `envguard publish` |
